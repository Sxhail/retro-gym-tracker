...
export default function InclineWalkScreen() {
  ...
  useEffect(() => {
    ...
    if (isRunning) {
      interval = setInterval(() => {
        ...
        // Rough calorie calculation (placeholder) - higher for incline
        setCalories(Math.floor(timeElapsed * 0.25)); 
      }, 1000);
    }
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>INCLINE WALK</Text>
