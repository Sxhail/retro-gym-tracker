...
export default function PowerWalkScreen() {
  ...
  useEffect(() => {
    ...
    if (isRunning) {
      interval = setInterval(() => {
        ...
        setCalories(Math.floor(timeElapsed * 0.18)); // Higher rate for power walking
      }, 1000);
    }
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>POWER WALK</Text>
